...
const paths=["/","/features","/guides","/guides/how-to-organize-medical-records","/guides/what-to-bring-to-doctor-appointment","/guides/emergency-medication-list","/guides/coordinate-older-adult-health-information","/guides/personal-health-record-vs-patient-portal","/about","/privacy","/terms"];
