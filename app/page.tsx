...
const steps=[
  ["01","Add what you already have","Upload visit notes, lab reports, discharge papers, and medication lists. LifeLens keeps the original alongside anything extracted from it."],
  ...
  ["03","Retrieve, don’t recall","Search the record by meaning, view events in order, or prepare a concise history for an appointment."],
] as const;
...
export default function Landing(){return <main className="min-h-screen bg-[#f4f2ec] font-sans text-[#182019] selection:bg-[#d5dccf]">
  ...
  <section id="principles" className="mx-auto grid max-w-[1440px] border-x border-b border-[#182019]/20 lg:grid-cols-2">
    ...
    <div className="divide-y divide-[#182019]/15">{[
      ["Sources remain visible","Every extracted event links back to the document or check-in it came from."],
      ["Missing means missing","If the answer is not in your record, LifeLens says so."],
      ["Changes are observations","Patterns are described against your own prior entries, without medical conclusions."],
  ...
  <section id="pricing" className="mx-auto max-w-[1440px] border-x border-b border-[#182019]/20">
    <div className="grid border-b border-[#182019]/20 lg:grid-cols-2">
      ...
      <div className="flex items-end p-6 md:p-10"><div><p className="max-w-lg text-base leading-7 text-black/55">Every plan includes private storage, source-linked records, timeline search, and export. Paid plans increase document processing and sharing—not the quality of your answers.</p><p className="mt-5 text-xs text-black/40">Prices shown in USD. Cancel or export your record at any time.</p></div></div>
    </div>
