...
const jsonLd={"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":`${origin}/#organization`,name:"LifeLens",url:origin,logo:`${origin}/lifelens-favicon.png`,email:"lifelens@bitlabsbuild.com"},{"@type":"WebSite","@id":`${origin}/#website`,url:origin,name:"LifeLens",description:"A private personal health record for medications, appointments, documents, memories, and family support.",publisher:{"@id":`${origin}/#organization`}},{"@type":"WebApplication","@id":`${origin}/#application`,name:"LifeLens",url:origin,applicationCategory:"HealthApplication",operatingSystem:"Any device with a modern web browser",browserRequirements:"Requires JavaScript and a modern web browser",description:"LifeLens helps individuals and families organize medications, appointments, medical documents, health timelines, memories, and permissioned family check-ins.",isAccessibleForFree:true,featureList:["Personal health timeline","Medication cabinet","Appointment tracking","Private medical document vault","Family health circle","Emergency card","Doctor visit summary","Health record search"],offers:[{"@type":"Offer",name:"Personal",price:"0",priceCurrency:"USD"},{"@type":"Offer",name:"Plus monthly",price:"8",priceCurrency:"USD"},{"@type":"Offer",name:"Family monthly",price:"14",priceCurrency:"USD"}],publisher:{"@id":`${origin}/#organization`}}]};
...
export default function Landing(){return <main className="min-h-screen bg-[#f4f2ec] font-sans text-[#182019] selection:bg-[#d5dccf]">
  ...
  <header className="border-b border-[#182019]/20">
    <div className="mx-auto flex h-16 max-w-[1440px] items-center px-5 md:px-10">
      ...
      <nav className="ml-auto hidden items-center gap-7 text-sm md:flex"><a href="#product">Product</a><Link href="/features">Features</Link><Link href="/guides">Guides</Link><a href="#pricing">Pricing</a><Link href="/about">About</Link></nav>
  ...
  <section id="pricing" className="mx-auto max-w-[1440px] border-x border-b border-[#182019]/20">
    ...
    <div className="flex flex-col justify-between gap-4 border-t border-[#182019]/20 p-6 text-sm md:flex-row md:items-center md:p-10"><div><b>Stay subscribed only as long as you need.</b><p className="mt-1 text-xs text-black/45">Subscriptions renew monthly or annually and can be managed or cancelled from Settings.</p></div><p className="max-w-lg text-xs leading-5 text-black/45">Document limits count successfully stored files. Existing files remain available after paid access ends; new uploads pause above the Personal limit.</p></div>
  </section>
  ...
  <section className="mx-auto max-w-[1440px] border-x border-b border-[#182019]/20 px-5 py-16 md:px-10 md:py-24"><div className="grid gap-10 lg:grid-cols-[.8fr_1.2fr]"><div><p className="text-xs font-semibold uppercase tracking-[.16em] text-black/40">Common questions</p><h2 className="mt-4 text-4xl font-medium tracking-[-.05em] md:text-5xl">What LifeLens is for.</h2></div><div className="divide-y divide-black/15 border-y border-black/15">{[
    ["What is a personal health record?","A personal health record is a health history that you maintain for yourself. LifeLens brings your medications, appointments, documents, check-ins, and important events into one organized timeline."],
    ["Can LifeLens replace my doctor or hospital portal?","No. LifeLens is an organizer for information you provide. It complements clinical systems but does not replace your doctor, hospital records, diagnosis, treatment, or emergency care."],
    ["Can I organize a family member’s health information?","LifeLens includes a permissioned Family Circle. The account owner chooses whom to invite and which parts of the record an invited person may view."],
    ["Can I prepare for a doctor appointment?","Yes. Doctor Visit Mode brings recorded medications, conditions, recent check-ins, appointments, and questions into a printable summary that you can verify before sharing."],
    ["Can I export my information?","Yes. Account settings include a structured record export, so your information is not trapped inside the application."],
  ].map(([question,answer])=><article key={question} className="py-6"><h3 className="text-lg font-semibold">{question}</h3><p className="mt-3 max-w-2xl text-sm leading-6 text-black/55">{answer}</p></article>)}</div></div></section>

  <footer className="border-t border-white/10 bg-[#1d2d23] text-white"><div className="mx-auto flex max-w-[1440px] flex-col justify-between gap-8 px-5 py-10 md:flex-row md:items-center md:px-10"><div><b>LifeLens</b><p className="mt-2 text-xs text-white/40">A personal health record.</p></div><div className="max-w-md text-xs leading-5 text-white/40">LifeLens organizes information provided by its users. It does not diagnose, prescribe, or replace a healthcare professional.</div><nav aria-label="Footer" className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm"><Link href="/features" className="whitespace-nowrap">Features</Link><Link href="/guides" className="whitespace-nowrap">Guides</Link><Link href="/about" className="whitespace-nowrap">About</Link><Link href="/privacy" className="whitespace-nowrap">Privacy</Link><Link href="/terms" className="whitespace-nowrap">Terms</Link><a href="mailto:lifelens@bitlabsbuild.com" className="whitespace-nowrap">Contact</a><Link href="/login" className="flex items-center gap-2 whitespace-nowrap">Sign in <ArrowUpRight size={14}/></Link></nav></div></footer>
</main>}
