...
export default function Landing(){return <main className="min-h-screen bg-[#f4f2ec] font-sans text-[#182019] selection:bg-[#d5dccf]">
  ...
  <header className="border-b border-[#182019]/20">
    <div className="mx-auto flex h-16 max-w-[1440px] items-center px-5 md:px-10">
      ...
      <nav className="ml-auto hidden items-center gap-7 text-sm md:flex"><a href="#product">Product</a><Link href="/features">Features</Link><a href="#pricing">Pricing</a><Link href="/about">About</Link></nav>
  ...
  <footer className="border-t border-white/10 bg-[#1d2d23] text-white"><div className="mx-auto flex max-w-[1440px] flex-col justify-between gap-8 px-5 py-10 md:flex-row md:items-center md:px-10"><div><b>LifeLens</b><p className="mt-2 text-xs text-white/40">A personal health record.</p></div><div className="max-w-md text-xs leading-5 text-white/40">LifeLens organizes information provided by its users. It does not diagnose, prescribe, or replace a healthcare professional.</div><nav aria-label="Footer" className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm"><Link href="/features" className="whitespace-nowrap">Features</Link><Link href="/about" className="whitespace-nowrap">About</Link><Link href="/privacy" className="whitespace-nowrap">Privacy</Link><Link href="/terms" className="whitespace-nowrap">Terms</Link><a href="mailto:lifelens@bitlabsbuild.com" className="whitespace-nowrap">Contact</a><Link href="/login" className="flex items-center gap-2 whitespace-nowrap">Sign in <ArrowUpRight size={14}/></Link></nav></div></footer>
</main>}
