...
export default function PrivacyPage() {
  ...
  return <LegalPage title="Privacy Policy" updated="August 13, 2026">
    ...
    <h2>Service providers</h2><p>Supabase provides authentication, database, and file storage. Vercel hosts the application. Google provides optional sign-in. Chapa processes payments. Each provider handles information under its own privacy terms.</p>
